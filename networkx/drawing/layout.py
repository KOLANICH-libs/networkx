...
def _layers2coords(G, layers, vertical=True,
                   base_layout_gen=fruchterman_reingold_layout,
                   seed=None):
    """
    Orders vertices within layers. Repeats following loop for some iterations:
        ...
        * Does `spring_layout`, initializing it with this grid hoping that it would reduce intersections and bring related vertices closer to each other.
    ...
    if base_layout_gen is not None:
        for i in range(3):
            ...
            base_layout = base_layout_gen(G, pos=coords, iterations=10)
